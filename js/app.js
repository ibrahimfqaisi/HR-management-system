...
Employee.prototype.theNetSalary = function () {
  this.salary = Math.floor(this.calulation() * (1 - 0.075))
...
function saveData(data){
  ...
  localStorage.setItem('information', stringArr);
}
 ...
 // console.log(objArray);
  ...
  if(objArray != null){
    ...
    for (let i = 0; i < objArray.length; i++) {
      ...
      new  Employee(objArray[i].employee_ID, objArray[i].fullName, objArray[i].department, objArray[i].level, objArray[i].image_URL)
